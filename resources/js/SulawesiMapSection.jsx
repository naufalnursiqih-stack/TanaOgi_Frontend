...
const provinces = [
    {
        ...
        capital: 'Makassar',
        highlight: true,
        description: 'Gerbang utama menuju keajaiban Sulawesi. Rumah bagi Tana Toraja, Karst Maros-Pangkep, dan Pantai Tanjung Bira.',
    },
    {
        id: 'sulbar',
        name: 'Sulawesi Barat',
...
const provincePaths = {
    ...
    sulut: "M 277.3,200.4 L 321.7,193.8 L 327.1,180.2 L 337.6,172.6 L 345.8,155.7 L 352.3,151.6 L 349.6,142.0 L 341.7,139.4 L 334.2,146.7 L 334.6,151.8 L 322.5,156.3 L 324.4,163.3 L 316.2,163.7 L 312.5,170.9 L 297.0,178.4 L 262.3,174.6 L 268.7,179.8 L 268.8,184.2 L 279.9,189.5 L 277.3,200.4 Z M 358.5,99.8 L 360.9,100.9 L 361.0,94.2 L 358.5,99.8 Z M 363.8,65.9 L 368.4,70.1 L 371.4,67.7 L 366.3,57.5 L 360.7,54.6 L 363.8,65.9 Z M 418.6,53.9 L 421.6,53.7 L 417.4,49.5 L 418.6,53.9 Z M 414.7,43.3 L 419.0,42.5 L 424.1,31.7 L 421.8,22.6 L 416.7,20.0 L 414.3,28.9 L 419.0,34.0 L 414.7,43.3 Z"
};
...
export default function SulawesiMapSection() {
        ...
        >
            ...
            <div style={{ maxWidth: '1340px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
                ...
                <div style={{
                    ...
                    }}>Temukan destinasi dan atraksi terbaik</span>
                ...
                <div style={{
                    ...
                    {/* ── SVG Map ── */}
                    <div style={{ position: 'relative', width: '100%' }} onMouseMove={handleMouseMove}>
                        <svg viewBox="50 0 420 550" style={{
                            width: '100%', height: 'auto', maxHeight: '540px',
                                ...
                                return (
                                    <g key={id}>
                                        <path
                                            ...
                                            style={{ cursor: 'pointer', transition: 'fill .35s ease' }}
                                        ...
                                        {isSulsel && (
                                            <>
                                                <circle cx={label.x} cy={label.y - 24} r="4.5" fill="#b32000" stroke="#fff" strokeWidth="1.8">
                                                ...
                                                <circle cx={label.x} cy={label.y - 24} r="10" fill="none" stroke="#b32000" strokeWidth="1.2" opacity=".35">
